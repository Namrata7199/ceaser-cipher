						    CO202- DESIGN OF DIGITAL SYSTEMS- MINI PROJECT 2017-18
									
							ENCRYPTION AND DECRYPTION USING CAESER CIPHER

						(Submitted by: Aditi Gupta (16CO202) Namrata Ladda(16CO121))
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

*This mini-project is an implementation of encryption and decryption using Caeser Cipher. 

*Input format: The user gives 4 inputs:
	       1. Encryption/Decryption (0/1)
	       2. Caps Lock (On/Off)
	       3. Alphabet (a-z or A-Z depending upon the Caps)
	       4. Shift Amount (1-26)

*Output format: The string is taken as an input from the user character wise and then the encrypted/decrypted character is shown on the TTY Display.
